...
KEY_LIST = ['AUTO', 'BAKERY', 'BEV', 'CARTON', 'CBD', 'CHEW', 'CHEW ROLLS', 'CIGARS', 'COFFEE', 'DELI ITEM', 'DELIVERY', 'E CIGG', 'E-CIG', 'FOUNTAIN', 'GROCERY', 'HBA', 'ICE', 'KANBE', 'PK CIGG', 'PLU NOT FOUND', 'REFILL', 'SLUSH', 'SNACK/LO TAX GRO']
